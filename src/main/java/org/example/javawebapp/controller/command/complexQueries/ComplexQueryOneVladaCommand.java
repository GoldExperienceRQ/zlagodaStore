...
public class ComplexQueryOneVladaCommand implements Command {
    @Override
    public String execute(HttpServletRequest req, HttpServletResponse res) throws ExecutionException, ServletException, IOException {
        ...
        req.setAttribute("queryResult", complexCommandJDBCDao.complexCommandOneVlada());

        return Page.COMPLEX_QUERY_ONE_VLADA;
    }
}
